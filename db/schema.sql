...
CREATE TABLE IF NOT EXISTS users (
    ...
    /*
       Progress mapping used by the backend:
    ...
    */
    ...
    easy_level INTEGER NOT NULL
        DEFAULT 1
        CHECK (easy_level BETWEEN 1 AND 101),

    medium_level INTEGER NOT NULL
        DEFAULT 1
        CHECK (medium_level BETWEEN 1 AND 101),

    hard_level INTEGER NOT NULL
        DEFAULT 1
        CHECK (hard_level BETWEEN 1 AND 101),
...
CREATE TABLE IF NOT EXISTS game_sessions (
    ...
    /*
       Server-generated puzzle.

       The frontend receives the puzzle,
       while the backend validates the submitted
       solution against the stored puzzle.
    */
...
CREATE INDEX IF NOT EXISTS idx_daily_bonus_date
ON daily_bonus_claims(claim_date);
...
CREATE TABLE IF NOT EXISTS ad_rewards (
    ...
    /*
       Numeric is used instead of integer so this table
       can support future providers/reward types.
    */
...
CREATE INDEX IF NOT EXISTS idx_ad_rewards_external
ON ad_rewards(
    provider,
    external_reward_id
);
...
CREATE TABLE IF NOT EXISTS withdrawals (
    ...
    CHECK (
        ...
        (
            ...
            AND LENGTH(TRIM(aba_account_name)) > 0
            AND aba_account_number IS NOT NULL
            AND LENGTH(TRIM(aba_account_number)) > 0
...
/* ============================================================
   APP SETTINGS UPDATED_AT TRIGGER
============================================================ */
